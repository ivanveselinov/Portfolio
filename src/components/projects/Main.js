...
function Main() {
    ...
    const Text=" lg: show w-full text-lg  break-words h-250 p-10 border-2 bg-blue-200 m-auto mt-1 focus:outline-none  overflow-x-hidden overflow-scroll rounded-xl mb-2 hidden md:block dark:bg-gray-400 dark:text-white";
